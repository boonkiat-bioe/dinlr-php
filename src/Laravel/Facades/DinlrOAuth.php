...
/**
 * @method static string getAuthorizationUrl(string $state)
 * @method static array handleCallback(array $params, string $expectedState)
 * @method static array getAccessToken(string $code, string $restaurantId)
 * @method static array refreshAccessToken()
 * @method static \Nava\Dinlr\OAuthClient setAccessToken(string $accessToken)
 * @method static \Nava\Dinlr\Auth\OAuth getOAuth()
 ...
 */
class DinlrOAuth extends Facade
{
    /**
